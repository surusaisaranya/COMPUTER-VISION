import cv2
import numpy as np
image = cv2.imread("C:/Users/Sai Saranya/Pictures/Screenshots/2.png")
img2 = cv2.imread('C:/Users/Sai Saranya/Pictures/Screenshots/Screenshot 2023-10-16 092102.png')
